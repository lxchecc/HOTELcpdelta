<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp64\www\git\hotel\public/../application/admin\view\system\systemsection.html";i:1519695671;}*/ ?>
...
<head>
  ...
  <link rel="stylesheet" href="/admin/font/css/font-awesome.min.css" />
    ...
    <body>
      <div class="Columns_style margin">
        ...
        <tbody>
          <tr>
           ...
           <td>产品管理</td>
           <td>高级管理员</td>
           <td class="displayPart" displayLength="80">餐厅，房间的添加，修改和删除</td>
           <td><?php echo $time; ?></td>
      ...
      <tr>
       ...
       <td>交易管理</td>
       <td>高级管理员</td>
       <td class="displayPart" displayLength="80">管理餐厅和房间所有的订单，包含退款处理，订单处理</td>
       <td><?php echo $time; ?></td>
       <td class="td-status"><span class="label label-success radius">已启用</span></td>
       <td class="td-manage">
  ...
  <tr>
   ...
   <td>会员管理</td>
   <td>超级管理员</td>
   <td class="displayPart" displayLength="80">管理所有的用户，禁止登陆</td>
   <td><?php echo $time; ?></td>
   <td class="td-status"><span class="label label-success radius">已启用</span></td>
   <td class="td-manage">
    <a onclick="member_stop(this,'1002')" href="javascript:;" title="启用" class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>
...
<td>消息管理</td>
<td>高级管理员</td>
<td class="displayPart" displayLength="80">管理所有的来自客户的消息和给所有用户发信息</td>
<td><?php echo $time; ?></td>
<td class="td-status"><span class="label label-success radius">已启用</span></td>
<td class="td-manage">
  <a onclick="member_stop(this,'1002')" href="javascript:;" title="启用" class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>
...
<td>管理员管理</td>
<td>超级管理员</td>
<td class="displayPart" displayLength="80">管理所有的管理员，禁止登陆后台和添加管理员、删除管理员</td>
<td><?php echo $time; ?></td>
<td class="td-status"><span class="label label-success radius">已启用</span></td>
<td class="td-manage">
  <a onclick="member_stop(this,'1002')" href="javascript:;" title="启用" class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>
