<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp64\www\git\hotel\public/../application/admin\view\transaction\ctrefund.html";i:1519695671;}*/ ?>
      ...
      <div class="refund_list">
        ...
        <tbody>
          ...
          <tr>
           ...
           <td>CTDD-<?php echo $value['yid']; ?></td>
           <td class="order_product_name">
             <?php if($value['c_type'] == 1): ?>
             <span style="color:red;">家庭套餐</span>
             <?php elseif($value['c_type'] == 2): ?>
             <span style="color:red">休闲套餐</span>
             <?php elseif($value['c_type'] == 3): ?>
             <span style="color:red">自助餐</span>
             <?php elseif($value['c_type'] == 4): ?>
             <span style="color:red">酒吧和休息室</span>
             <?php elseif($value['c_type'] == 5): ?>
             <span style="color:red">户外套餐</span>
             <?php elseif($value['c_type'] == 6): ?>
             <span style="color:red">婚礼用餐</span>
             <?php endif; ?>
           </td>
           ...
           <td>
            <?php if($value['y_refund'] == 1): ?>
            <a onClick="Delivery_Refund(this,<?php echo $value['yid']; ?>)"  href="javascript:;" title="退款"  class="btn btn-xs btn-success">退款</a> 
            <?php endif; ?>
...
<script>
 ...
 function Delivery_Refund(obj,id){
  ...
  layer.confirm('是否退款当前商品价格！',function(index){
    $.ajax({
      "type":"post",
      "url":"/admin/Transaction/ctrefund",
      'data':{
        'yid':id
      },
      success:up
    ...
    function up(data)
    {
      if (data == 1){
       ...
       window.setTimeout("window.location='/admin/Transaction/ctrefund'",1000);
     }else{
      layer.alert('退款成功！',{
       title: '提示框',        
       icon:1,    
