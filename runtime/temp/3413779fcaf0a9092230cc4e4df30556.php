<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\wamp64\www\git\hotel\public/../application/admin\view\transaction\ctmenu.html";i:1519695671;}*/ ?>
    ...
    <body>
      <div class="margin clearfix">
       ...
       <div class="border clearfix">
        ...
        <a title="打印表格"  href="/admin/Transaction/excel"  class="btn btn-xs btn-info Refund_detailed" >打印表格</a>
      ...
      <div class="refund_list">
        <table class="table table-striped table-bordered table-hover" id="sample-table">
          <thead>
           <tr>
            ...
            <th width="250px">餐厅类型</th>
            <th width="100px">用户ID</th>       
            <th width="100px">用户等级</th>       
        ...
        <?php foreach($res as $value): ?>
         <tr>
          ...
          <td>
           <a title="退款订单详细"  href="/admin/Transaction/ctxx?yid=<?php echo $value['yid']; ?>"  class="btn btn-xs btn-info Refund_detailed" >详细</a> 
         </td>
       </tr>
       <?php endforeach; ?>
   </tbody>
