<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\wamp64\www\git\hotel\public/../application/admin\view\acticle\articlesort.html";i:1519695671;}*/ ?>
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
        ...
        <?php foreach($res as $value): ?>
         <tr>
          ...
          <td><?php echo $value['x_title']; ?></td>
          <td class="displayPart" displayLength="60"><?php echo $value['x_content']; ?></td>
          <td><?php echo $value['x_time']; ?></td>
          <td>启用</td>          
          <td class="td-manage">   
         <!--   <a title="编辑" onclick="member_edit('510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>  -->     
           <a title="删除" href="javascript:;"  onclick="member_del(this,<?php echo $value['xid']; ?>)" class="btn btn-xs btn-danger" ><i class="fa fa-trash  bigger-120"></i></a>
         </td>
       </tr>
       <?php endforeach; ?>
</tbody>
