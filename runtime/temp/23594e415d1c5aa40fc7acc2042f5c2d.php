<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\wamp64\www\git\hotel\public/../application/admin\view\transaction\amounts.html";i:1519695671;}*/ ?>
    ...
    <body>
      <div class="margin clearfix">
       <div class="amounts_style">
         <div class="transaction_Money clearfix">
          <div class="Money"><span >成交总额：<?php echo $money; ?>元</span><p>最新统计时间:<?php echo $time; ?></p></div>
          <div class="Money"><span ><em>￥</em><?php echo $todaymoney; ?>元</span><p>当天成交额</p></div>
       ...
       <div class="border clearfix">
        ...
        <span class="r_f">共：<b><?php echo $dd; ?></b>笔</span>
      </div>
      <div class="Record_list">
        ...
        <?php foreach($res as $value): ?>
          <tr>
           <td>LZCYZH-<?php echo $value['oid']; ?></td>
