<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\wamp\www\tp\hotel\public/../application/index\view\contact\contact.html";i:1519732329;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>Contact</title>
			...
			<div class="contact">
				<div class="container">
					...
					<div class="col-md-8 contact-left cont">
						<h4>需求留言表</h4>
						<form id="review">
							<input type="text" name="Name" value="姓名" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '请补全姓名';}" required="">
							<input type="email" name="Email" value="邮箱" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '请补全邮箱';}" required="">
							<input type="text" name="Phone" value="电话" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '请补全电话';}" required="">
							<textarea type="text" name="Message"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '请补全您的信息';}" required="">您的需求可以写在这里</textarea>
							<input type="submit" class="sub" value="提交" >
							<input type="reset" class="res" value="清除" >
						</form>
					</div>
					<div class="clearfix"> </div>
				</div>
...
$('#review .sub').on('click' ,function(){
		 $.ajax({
                "type":"post",
                "url":"/index/Contact/review",
                "dataType":"json",
                "data":{
                "name":$("#review input[name=Name]").val(),
                "email":$('#review input[name=Email]').val(),
                "phone":$('#review input[name=Phone]').val(),
