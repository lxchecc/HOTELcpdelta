...
class Msg 
{
    ...
    public function __construct($accountSid = 'c88cbef493d0638f050f771752246f21' , $token = '852b4dc301226163efcc9b634738bced')
    {
        $this->accountSid = $accountSid;
        $this->token = $token;
        $this->num = substr(md5(mt_rand(0,9)),0,4);
    } 

    public function msg($phone = "15040579369",$appId = "758ccf9b304e48c5ba8fc92f0f589c65",$templateId = "278780") {
        $ucpass = new Ucpaas($this->accountSid,$this->token);
