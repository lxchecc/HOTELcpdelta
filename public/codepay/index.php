            ...
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您选择充值：<label
                            ...
                            <input type="text" name="price" id="price" placeholder="如：50" value="0.01" readonly
                    ...
                    <li class="gray6"
                        ...
                        充值用户名：<label
                            ...
                            <input type="text" name="user" id="user" placeholder="用户名" value="<?php echo $user ?>" readonly 
