 ...
 */
$codepay_config['page'] = 3; //支付页面展示方式
...
define('DB_PWD', 'cheng123');//数据库密码
define('DB_NAME', 'taobao');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'hotel_user');  //充值用户所在数据库表名
define('DB_USERMONEY', 'u_money');  //充值用户所在表中的金额字段名
